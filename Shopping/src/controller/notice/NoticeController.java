...
import controller.goods.GoodsJoinPage;
import controller.goods.GoodsListPage;
import controller.goods.GoodsModifyPage;
import controller.goods.GoodsNumberPage;
import controller.goods.GoodsUpdatePage;
...
public class NoticeController extends HttpServlet implements Servlet{
	...
	public void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(command.equals("/noticeList.nt")) {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("notice/noticeJoin.jsp");
			dispatcher.forward(request, response);
