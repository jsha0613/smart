...
<input type="hidden" name="memId" value="${dto.memId }" />
   <table border = 1 align="center">
      ...
      <tr><td>주소</td>
         <td><input type="text" name="memAddress" id="sample4_roadAddress" value="${dto.memAddress }" size="30">
      ...
      <tr><td>이메일 수신여부</td>
         <td><input type="radio" name="memEmailCk" value="Y" <c:if test="${dto.memEmailCk == 'Y'}">checked</c:if>>예
         <input type="radio" name="memEmailCk" value="N" <c:if test="${dto.memEmailCk == 'N'}">checked</c:if>>아니오</td></tr>
      <tr><td colspan="2" align="center">
            <input type="submit" value="수정 완료" />
            <input type="button"  value="수정 안함" 
               onclick="javascript:history.back();" />
            <input type="button"  value="회원 탈퇴"  onclick="javascript:location.href='memDel.mem?memId=${dto.memId }'" />
         </td></tr>
   </table>
</form>
</body>
